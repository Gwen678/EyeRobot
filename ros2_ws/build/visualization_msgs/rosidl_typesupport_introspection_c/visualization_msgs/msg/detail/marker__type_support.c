...
static rosidl_typesupport_introspection_c__MessageMember visualization_msgs__msg__Marker__rosidl_typesupport_introspection_c__Marker_message_member_array[15] = {
  {
    "header",  // name
