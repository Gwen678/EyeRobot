...
public:
  ...
  : msg_(msg)
  {}
  Init_Marker_mesh_use_embedded_materials mesh_resource(::visualization_msgs::msg::Marker::_mesh_resource_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Marker_text colors(::visualization_msgs::msg::Marker::_colors_type arg)
  {
