...
#include "rosapi_msgs/srv/detail/set_param__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosapi_msgs::srv::SetParam_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rosapi_msgs::srv::SetParam_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosapi_msgs::srv::SetParam_Request *>(
    untyped_ros_message);
...
{
  return &rosapi_msgs::srv::typesupport_fastrtps_cpp::_SetParam_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosapi_msgs::srv::SetParam_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rosapi_msgs::srv::SetParam_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rosapi_msgs::srv::SetParam_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rosapi_msgs::srv::typesupport_fastrtps_cpp::_SetParam_Response__handle;
}
...
static rosidl_service_type_support_t _SetParam__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &rosapi_msgs::srv::typesupport_fastrtps_cpp::_SetParam__handle;
}
