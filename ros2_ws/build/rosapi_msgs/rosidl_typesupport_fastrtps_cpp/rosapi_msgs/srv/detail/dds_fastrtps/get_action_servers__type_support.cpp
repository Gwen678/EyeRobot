  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosapi_msgs::srv::GetActionServers_Request;
    is_plain =
      (
...
static size_t _GetActionServers_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetActionServers_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosapi_msgs::srv::GetActionServers_Response;
    is_plain =
      (
...
static size_t _GetActionServers_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetActionServers_Response(full_bounded, is_plain, 0);
