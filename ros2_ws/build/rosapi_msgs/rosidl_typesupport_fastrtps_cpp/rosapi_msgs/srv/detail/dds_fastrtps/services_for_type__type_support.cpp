...
#include "rosapi_msgs/srv/detail/services_for_type__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosapi_msgs::srv::ServicesForType_Request;
    is_plain =
      (
...
static size_t _ServicesForType_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ServicesForType_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosapi_msgs::srv::ServicesForType_Response;
    is_plain =
      (
...
static size_t _ServicesForType_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ServicesForType_Response(full_bounded, is_plain, 0);
