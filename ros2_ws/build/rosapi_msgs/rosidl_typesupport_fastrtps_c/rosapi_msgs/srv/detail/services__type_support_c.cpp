...
#include "rosapi_msgs/srv/detail/services__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosapi_msgs__srv__Services_Request;
    is_plain =
      (
...
static size_t _Services_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosapi_msgs__srv__Services_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rosapi_msgs__srv__Services_Response;
    is_plain =
      (
...
static size_t _Services_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosapi_msgs__srv__Services_Response(
    full_bounded, is_plain, 0);
