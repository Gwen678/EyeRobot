...
#include "vision_msgs/msg/detail/classification3_d__rosidl_typesupport_fastrtps_c.h"
...
using _Classification3D__ros_msg_type = vision_msgs__msg__Classification3D;

static bool _Classification3D__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Classification3D__ros_msg_type * ros_message = static_cast<const _Classification3D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _Classification3D__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Classification3D__ros_msg_type * ros_message = static_cast<_Classification3D__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_vision_msgs__msg__Classification3D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Classification3D__ros_msg_type * ros_message = static_cast<const _Classification3D__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Classification3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__Classification3D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t max_serialized_size_vision_msgs__msg__Classification3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_msgs__msg__Classification3D;
    is_plain =
      (
      offsetof(DataType, source_cloud) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Classification3D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_vision_msgs__msg__Classification3D(
...
static message_type_support_callbacks_t __callbacks_Classification3D = {
  "vision_msgs::msg",
  "Classification3D",
  _Classification3D__cdr_serialize,
  _Classification3D__cdr_deserialize,
  _Classification3D__get_serialized_size,
  _Classification3D__max_serialized_size
};

static rosidl_message_type_support_t _Classification3D__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Classification3D,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msgs, msg, Classification3D)() {
  return &_Classification3D__type_support;
}
