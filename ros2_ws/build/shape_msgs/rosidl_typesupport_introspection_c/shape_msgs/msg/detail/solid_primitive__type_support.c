...
static rosidl_typesupport_introspection_c__MessageMember shape_msgs__msg__SolidPrimitive__rosidl_typesupport_introspection_c__SolidPrimitive_message_member_array[2] = {
  {
    "type",  // name
