...
can subscribe to it reliably over a live WebSocket connection."""
import rclpy
...
class UrdfRelayNode(Node):
    def __init__(self) -> None:
        ...
        # Use the robot-specific topic, not /robot_description, which depthai also
        # publishes; using the shared topic caused the camera URDF to be relayed.
        ...
        # VOLATILE has no replay; re-publish the cached URDF at 1 Hz so
        # foxglove_bridge panels that open late still receive it.
